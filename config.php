...
define('URL', 'http://'.$_SERVER['HTTP_HOST'].'/18bitsgaming/');
define('ADMIN_URL', 'http://'.$_SERVER['HTTP_HOST'].'/18bitsadmin/');
define('LIBS', 'libs/');
define('UTILS', 'util/');
define('NAME', '18bits Gaming');
define('META_AUTHOR', 'Aguolu Arinze');
define('DESCRIPTION', 'Indie Game Company');
